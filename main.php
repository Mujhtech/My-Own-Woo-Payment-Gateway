<?php
/**
Plugin Name: My Own Woocommerce Payment Gateway
...
Text Domain: my-own-woocommerce-payment-gateway
...
function moowpg_add_gateway_class( $gateways ) {
	$gateways[] = 'WC_MOOWPG_Gateway'; // your class name is here
	return $gateways;
}


add_action( 'plugins_loaded', 'moowpg_init_gateway_class' );

function moowpg_init_gateway_class() {
 
	class WC_MOOWPG_Gateway extends WC_Payment_Gateway {
		 ...
		 */
	 	public function payment_scripts() {
			...
			wp_enqueue_script( 'woocommerce_moowpg' );
